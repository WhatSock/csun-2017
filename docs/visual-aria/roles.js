		...
		bind(document.body, 'mousedown', function(ev){
			if (ev.shiftKey && ev.ctrlKey){
				...
				if (role && rmo.nodeType === 1)
					rmo.href = 'matrices/index.htm#' + role;
